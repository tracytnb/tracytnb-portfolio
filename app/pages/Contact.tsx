...
const Contact = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full gap-5 sm:gap-5 md:gap-15 lg:gap-0">
        <div className="flex flex-col sm:flex-col md:flex-row gap-10">
          ...
          <div className="flex flex-col gap-6 md:w-3/5 lg:w-2/5 md:px-5 pr-20">
            <p className="text-lg lg:text-[1.2vw] text-foreground font-semibold leading-5 sm:leading-5 md:leading-snug">
              Based in{" "}
